...
public class ArtistaRepository {
    ...
    private void initialize() {
        ...
        addArtista(new Artista(2, "Abdul","Fal Rute","Todo tipo de cuentos ...","Cuentomagico","649132564", "Soy un artista entregado a mi hobby y profesión ... ", 5.0, ProvinciaRepository.getInstance().getProvincias().get(1), null, "Cuentos Clásicos S.L.", "1A2b3c", "Cuentacuentos", null, 45, "artista2@gmail.com"));
